...
from robofei.env.callbacks import TensorboardCallback
...
class DarwinOp3_TestEnv(unittest.TestCase):
    def test_checkenv(self):
        ...
        env = gym.make('DarwinOp3-v2', render_mode="rgb_array", width=1024, height=768)
    ...
    def test_callback(self):
        ...
        # env = gym.make('DarwinOp3-v2', render_mode="rgb_array", width=1920, height=1080)
        env = gym.make('DarwinOp3-v2')
    ...
    def test_multi_env(self):
        ...
        env = make_vec_env('DarwinOp3-v2', n_envs=4)
        model = PPO(MlpPolicy, env, verbose=1, device="cpu", n_steps=2048, batch_size=64, n_epochs=10)
